  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card card-secondary">
        ...
        <form action="/donation/external/submit" method="POST">
          @csrf
          @method('POST')
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" id="inputSpentBudget" class="form-control" name="phone" required>
            </div>
            <div class="form-group">
              <label for="inputEstimatedDuration">Amount</label>
              <input type="text" id="inputEstimatedDuration" class="form-control" name="amount" required>
            </div>
          </div>
          <!-- /.card-body -->
      </div>
